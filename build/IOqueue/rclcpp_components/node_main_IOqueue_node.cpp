...
#define NODE_MAIN_LOGGER_NAME "IOqueue_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libIOqueue.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<io_queue::IOqueue>";

...
#define NODE_MAIN_LOGGER_NAME "test_loopback_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libtest_loopback.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<test_loopback::LoopbackNode>";

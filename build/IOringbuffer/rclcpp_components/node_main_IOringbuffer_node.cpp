...
#define NODE_MAIN_LOGGER_NAME "IOringbuffer_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libIOringbuffer.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<io_ringbuffer::IOringbuffer>";

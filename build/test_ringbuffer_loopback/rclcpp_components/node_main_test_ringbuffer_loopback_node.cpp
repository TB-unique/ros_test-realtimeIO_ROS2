...
#define NODE_MAIN_LOGGER_NAME "test_ringbuffer_loopback_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libtest_ringbuffer_loopback.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<test_ringbuffer_loopback::RingbufferLoopbackNode>";

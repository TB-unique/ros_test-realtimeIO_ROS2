...
static const _ByteRows_type_support_symbol_names_t _ByteRows_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, main_interface, msg, ByteRows)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, main_interface, msg, ByteRows)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, main_interface, msg, ByteRows)() {
  return &::main_interface::msg::rosidl_typesupport_c::ByteRows_message_type_support_handle;
}

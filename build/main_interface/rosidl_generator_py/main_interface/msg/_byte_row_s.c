...
bool main_interface__msg__byte_row__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("main_interface.msg._byte_row.ByteRow", full_classname_dest, 36) == 0);
  }
  main_interface__msg__ByteRow * ros_message = _ros_message;
  {  // data
...
{
  /* NOTE(esteve): Call constructor of ByteRow */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("main_interface.msg._byte_row");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ByteRow");
